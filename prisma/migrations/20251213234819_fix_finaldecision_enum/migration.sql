-- CreateEnum
CREATE TYPE "FinalDecision" AS ENUM ('agreed', 'declined', 'pending');
...
CREATE TABLE "Campaign" (
    ...
    "userId" VARCHAR(255),
    "createdAt" TIMESTAMPTZ(6) DEFAULT (now() AT TIME ZONE 'Asia/Jakarta'::text),
    "updatedAt" TIMESTAMP(6) DEFAULT (now() AT TIME ZONE 'Asia/Jakarta'::text),
    "finalDecision" "FinalDecision" NOT NULL DEFAULT 'pending',
